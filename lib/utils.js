...
export {
    compareHash as compare,
    parseImportedFilesFromFileContent as rgx,
    getFileImportsFullPaths as paths,
    getFilesImportedInByFilesImports as imports,
    getFilesWithDependencies as files
}